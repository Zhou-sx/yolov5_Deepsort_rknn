...
RKNN_MODEL_PATH = r'./infrared_dt.rknn'
IMG_PATH = r'./demo.png'
SIZE = (640, 640)
...
class RKNNDetector:
    """
        ...
        <2> 后处理 _predict 得到的结果是 [Xmin, Ymin, Xmax, Ymax, confidence, class]
    """
...
if __name__ == '__main__':
    ...
    # print(os.path.exists(r"./data/images/bus.jpg"))
    box_list = detector.predict(img)
